...
(3, 'Mouse', '2023-10-02', 18, 30, 500, 600),
(4, 'Rode Mic', '2023-10-20', 9, 10, 15000, 18000);
...
(6, 49, 'Mic not working', 'my mic is not working', 'Jay', '6565', 'Col', 'Bokaro', 'Jh', 6565, 'jay@gmail.com', 656567, 'Jay Kisan', '2023-10-14'),
(7, 50, 'Jack and Jones', 'Hello There have you seen this movie', 'Raj', '123', 'Sector Five', 'Bokaro', 'Jharkhand', 123456, 'raj@gmail.com', 234234234, 'Kabir', '2023-10-16'),
(8, 50, 'Jack and Jones', 'Hello There have you seen this movie', 'Raj', '123', 'Sector Five', 'Bokaro', 'Jharkhand', 123456, 'raj@gmail.com', 234234234, 'Jay', '2023-10-21'),
(9, 52, 'LCD Not working', 'my lcd is not working properly', 'Rahul', 'HOuse No. 123', 'Railway', 'Bokaro', 'Jh', 12345, 'rahul@gmail.com', 234566, 'Kunal', '2023-10-21'),
(10, 52, 'Rode Mic Note Working', 'my rode mic is not working properly', 'Sam', 'house no 234', 'Sec 3', 'Kolkata', 'West Bengal', 674534, 'user@gmail.com', 1234566782, 'Tech1', '2023-10-21');
...
(1, 'Shukla', 'Bokaro', 'Mouse', 1, 600, 600, '2023-10-13'),
(2, 'Pandey ji', 'Ranchi', 'Mouse', 2, 600, 600, '2023-10-13'),
(3, 'Musaddi Lal', 'Bokaro', 'Mouse', 5, 600, 3000, '2023-10-13'),
(4, 'Jay Ho', 'Ranchi', 'Mouse', 2, 600, 1200, '2023-10-13'),
(5, 'something', 'somethingadd', 'Mouse', 1, 600, 600, '2023-10-13'),
(6, 'someone', 'someoneadd', 'Keyboard', 1, 500, 500, '2023-10-13'),
(7, 'jay', 'jay ho', 'Keyboard', 1, 500, 500, '2023-10-09'),
(8, 'Jay', 'Bokaro', 'Keyboard', 2, 500, 1000, '2023-10-21'),
(9, 'Kumar', 'Bokaro', 'Keyboard', 1, 500, 500, '2023-10-20'),
(10, 'kkk', 'asdsa', 'Keyboard', 1, 500, 500, '2023-10-20'),
(11, 'Shukla Ji', 'Ranchi', 'Samsung LCD', 1, 12000, 12000, '2023-10-20'),
(19, 'sdsads', 'dasdsa', 'Keyboard', 1, 500, 500, '2023-10-20'),
(20, 'asdas', 'asdsad', 'Keyboard', 1, 500, 500, '2023-10-20'),
(21, 'dsadas', 'asdasd', 'Samsung LCD', 1, 12000, 12000, '2023-10-20'),
(22, 'sdfsdf', 'dfsdf', 'Samsung LCD', 1, 12000, 12000, '2023-10-20'),
(23, 'Ramu', 'sadsad', 'Samsung LCD', 1, 12000, 12000, '2023-10-20'),
(24, 'gfdgfdg', 'fgfdgfdg', 'Samsung LCD', 1, 12000, 12000, '2023-10-20'),
(25, 'rrr', 'fgdf', 'Mouse', 1, 600, 600, '2023-10-20'),
(26, 'Jay', 'ranchi', 'Samsung LCD', 1, 12000, 12000, '2023-10-20'),
(27, 'dfsdfsd', 'sdfdsf', 'Mouse', 1, 600, 600, '2023-10-20'),
(28, 'Kunal', 'Ranchi', 'Rode Mic', 1, 18000, 18000, '2023-10-20');
...
(50, 'Jack and Jones', 'Hello There have you seen this movie', 'Raj', '123', 'Sector Five', 'Bokaro', 'Jharkhand', 123456, 'raj@gmail.com', 234234234, '2023-10-13'),
(51, 'asdsadsa', 'asdsadsa', 'dasdsad', 'asdasd', 'sdsadsa', 'asdsad', 'sadasd', 1413123, 'dsadas@gmail.com', 4131323, '2023-10-20'),
(52, 'Rode Mic Note Working', 'my rode mic is not working properly', 'Sam', 'house no 234', 'Sec 3', 'Kolkata', 'West Bengal', 674534, 'user@gmail.com', 1234566782, '2023-10-20');
