...
<body>
  <!-- Start Navigation -->
  <nav class="navbar navbar-expand-sm navbar-dark bg-custom-dark-blue pl-5 fixed-top">
    <a href="index.php" class="navbar-brand">OSMS</a>
    <span class="navbar-text">Service at your Door step</span>
  ...
  <header class="jumbotron back-image" style="background-image: url(images/service.jpg);">
    <div class="myclass mainHeading">
      <h1 class="text-uppercase text-danger font-weight-bold">Welcome to OSMS</h1>
      <p class="font-italic">Service at your Door step</p>
  ...
  <div class="jumbotron bg-custom-dark-blue" id="Customer">
        ...
        <div class="col-lg-3 col-sm-6">
          ...
          <div class="card shadow-lg mb-2">
            <div class="card-body text-center">
              ...
              <p class="card-text">Good customer service.</p>
            </div>
          </div>
        ...
        <div class="col-lg-3 col-sm-6">
          ...
          <div class="card shadow-lg mb-2">
            <div class="card-body text-center">
              ...
              <p class="card-text">Timely response to Customer issues.</p>
            </div>
          </div>
  ...
  <!-- Start Footer-->
  <footer class="container-fluid bg-custom-dark-blue text-white mt-5" style="border-top: 3px solid #DC3545;">
      ...
      <div class="row py-3">
        ...
        <div class="col-md-6">
          ...
          <span class="pr-2">Follow Us: </span>
            <a href="#" target="_blank" class="pr-2 text-danger"><i class="fab fa-facebook-f"></i></a>
           <a href="#" target="_blank" class="pr-2 text-danger"><i class="fab fa-twitter"></i></a>
           <a href="#" target="_blank" class="pr-2 text-danger"><i class="fab fa-youtube"></i></a>
           <a href="#" target="_blank" class="pr-2 text-danger"><i class="fab fa-google-plus-g"></i></a>
           <a href="#" target="_blank" class="pr-2 text-danger"><i class="fas fa-rss"></i></a>

        </div> <!-- End Footer 1st Column -->

        <div class="col-md-6 text-right">
          <!-- Start Footer 2nd Column -->
          <small> Designed by Snehal &copy; 2024. 
          </small>
          <small class="ml-2"><a href="Admin/login.php" class="text-danger">Admin Login</a></small>
